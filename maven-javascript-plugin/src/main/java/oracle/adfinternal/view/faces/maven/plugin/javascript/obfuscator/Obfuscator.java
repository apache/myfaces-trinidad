...
package oracle.adfinternal.view.faces.maven.plugin.javascript.obfuscator;
...
import oracle.adfinternal.view.faces.maven.plugin.javascript.obfuscator.filters.ObfuscatorFilter;
import oracle.adfinternal.view.faces.maven.plugin.javascript.obfuscator.filters.compression.CompressionFilter;
import oracle.adfinternal.view.faces.maven.plugin.javascript.obfuscator.filters.keywords.SpecialKeywordsFilter;
import oracle.adfinternal.view.faces.maven.plugin.javascript.obfuscator.filters.obfuscation.ObfuscationFilter;
import oracle.adfinternal.view.faces.maven.plugin.javascript.obfuscator.filters.output.OutputGenerator;
import oracle.adfinternal.view.faces.maven.plugin.javascript.obfuscator.javascript15parser.AnnotatedToken;
import oracle.adfinternal.view.faces.maven.plugin.javascript.obfuscator.javascript15parser.JSParser15;
import oracle.adfinternal.view.faces.maven.plugin.javascript.obfuscator.javascript15parser.ParseException;
import oracle.adfinternal.view.faces.maven.plugin.javascript.uixtools.FileProcessor;
