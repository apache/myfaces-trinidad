 ...
 */
public class CasablancaTabletSkin extends SkinExtension {

  /**
   * Constructs a CasablancaDesktopSkin instance
   */
  public CasablancaTabletSkin(Skin baseSkin)
  {
    // Create a SkinExtension for Casablanca
    super(baseSkin,
            _CASABLANCA_TABLET_ID,
          TrinidadRenderingConstants.CASABLANCA_SKIN_FAMILY,
          TrinidadRenderingConstants.APACHE_TRINIDAD_TABLET);
  ...
  // Casablanca skin id
  private static final String _CASABLANCA_TABLET_ID = "casablanca.tablet";


  // Casablanca skin style sheet name
  private static final String _CASABLANCA_STYLE_SHEET_NAME =
    "META-INF/adf/styles/casablanca-tablet.css";
}
