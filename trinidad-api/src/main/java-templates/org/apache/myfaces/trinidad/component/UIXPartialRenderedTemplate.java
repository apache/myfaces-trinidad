...
/**/  public abstract boolean isAlwaysRendered();
  ...
  /**
   * @see org.apache.myfaces.trinidad.component.UIXComponentBase#decode(javax.faces.context.FacesContext)
   */
  @Override
    ...
    if (comp != null)
    {
      ...
      if (adfContext != null)
      {
        ...
        else
        {
          ...
          {
            adfContext.addPartialTriggerListeners(comp, (String[]) partialTriggers);
          }
        }
      }
    }
