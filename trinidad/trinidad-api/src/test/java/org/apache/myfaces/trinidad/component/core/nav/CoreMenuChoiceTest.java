...
/**
 * Unit tests for CoreMenuChoice.
 *
 * @author Gabrielle Crawford
 */
public class CoreMenuChoiceTest extends UIComponentTestCase
{
  /**
   * Creates a new CoreMenuChoiceTest.
   *
   * @param testName  the unit test name
   */
  public CoreMenuChoiceTest(
    String testName)
  {
    super(testName);
  }
  ...
  {
    CoreMenuChoice component = new CoreMenuChoice();
  ...
  public void testAttributeTransparency()
  {
    ...
    doTestAttributeTransparency(component, "title",
                                "foo", "bar");
  }
