...
public final class IntegerUtils
{
  ...
  /**
   * @return an Integer object for the specified integer, possibly
   * creating a new Integer object if a cached one does not exist.
   */
    ...
    )
  {
    ...
    {
      Integer cachedValue = _sCachedIntegers[cacheIndex];

      if (cachedValue == null)
      {
        cachedValue = new Integer(intValue);

        _sCachedIntegers[cacheIndex] = cachedValue;
      }
